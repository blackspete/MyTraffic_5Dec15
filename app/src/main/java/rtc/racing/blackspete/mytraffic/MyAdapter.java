...
/**
 * Created by Administrator on 6/12/2558.
 */
public class MyAdapter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = objLayoutInflater.inflate(R.layout.my_listview,parent,false); //พาหะการนำพา
        //setup textview

        TextView titleTextView = (TextView) view.findViewById(R.id.textView2); //ประกาศตัวแปรกับวิกเกด
